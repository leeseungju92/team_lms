		...
		<div class="wrap_content">
			...
			<div class="board_title_box">
				<div class="board_title_content">
					...
					<div class="margin_left title_line"><input class="title_input" placeholder="제목을 입력하세요" type="text" name="title" var="${title}"></div>
				</div>
			</div>
			...
			<div class="board_content_box">
				<div class="board_content_content">
					...
					<div class="margin_left"><textarea class="txt_content" placeholder="내용을 입력하세요" name="content" var="${content}"></textarea></div>
				</div>
			</div>
			...
			<div class="writer_btn">
				...
				<button id="register_btn" class="agree btn" type="button">등록</button>
			</div>
